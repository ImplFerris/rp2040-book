...
- [PIO](./pio/index.md)
    ...
    - [FIFO](./pio/internals/fifo.md)  
        - [LED with FIFO](./pio/internals/led-fifo.md)
        - [Code](./pio/internals/led-fifo-code.md)
    - [Side Set](./pio/internals/side-set.md)
    - [WS2812](./pio/ws2812/index.md)
        - [How it works?](./pio/ws2812/how-it-works.md)
        - [Bit Cycles](./pio/ws2812/timing-and-pio-clock-cycles.md)
