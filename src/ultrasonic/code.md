...
When prompted, give your project a name like "bat-beacon". You will then be asked whether you want to enable defmt logging. Enable it if you have a debug probe available so you can view logs during development.
...
cd rp2040-projects/embassy/ultrasonic
```
