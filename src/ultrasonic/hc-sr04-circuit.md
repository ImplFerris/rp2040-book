# Wiring the HC-SR04 to the Pico Using a Voltage Divider
...
## Connection for the Raspberry Pi Pico and Ultrasonic Sensor
...
- **VCC**: Connect the VCC pin on the HC-SR04 to VBUS (Pin 40) on the Pico. The HC-SR04 requires 5V power, and VBUS provides 5V from the USB connection.
- **Trig**: Connect to GPIO 17 on the Pico to trigger the ultrasonic sound pulses.
- **Echo**: Connect to GPIO 16 on the Pico through a voltage divider (1kΩ resistor from Echo pin, 2kΩ or 2.2kΩ resistor to ground). The junction between the resistors connects to GPIO 16. This divider steps down the 5V Echo signal to ~3.4V, protecting the Pico's 3.3V GPIO pins.
- **GND**: Connect to any ground pin on the Pico.


<a href="./images/HC-SR04-pico-rp2040-voltage-divider-circuit.png"><img style="display: block; margin: auto;" alt="pico" src="./images/HC-SR04-pico-rp2040-voltage-divider-circuit.png"/></a>
